      ...
      const contentResponse = {
        ...
        battleroyalenews: {
          news: {
            ...
            motds: [
              {
                image: "https://i.ibb.co/QFCD6zM/Eon-Mares-News.png",
                titleImage: "https://i.ibb.co/QFCD6zM/Eon-Mares-News.png",
                hidden: false,
                tabTitleOverride: "Eonmares",
                _type: "CommonUI Simple Message MOTD",
                title: "Eonmares",
                body: "Eonmares has officially released, enjoy it while you can!",
                id: "Eon",
                spotlight: false,
              },
            ],
        ...
        playlistinformation: {
          ...
          frontend_matchmaking_header_text_description: "Eonmares",
          frontend_matchmaking_header_text: "Eon",
          playlist_info: {
